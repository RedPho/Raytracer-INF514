  ...
  if (hit) {
    ...
    */
    if (renderable->reflectance() > 0 &&
      ...
      vec3 reflected_color = shade_closest_intersection(incident_ray.reflect(hit->position, hit->normal), 0.00001); //recursive bir sekilde rayin reflectlenmis halindeki shadei hesapliyoruz
